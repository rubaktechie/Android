...
public class ThreeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = "http://rubak.cloudapp.net/android/stopped.php";
    ...
    public void perform(View v) {
        ...
        lv.setAdapter(new CustomAdapter(getActivity(), from_city, to_city, product, truck_type, offerrate, all_values, "three_fragment"));
    }
}
